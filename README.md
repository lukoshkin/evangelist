...
- <details>
  ...
  | any  |   `<C-q>`    | Deletes the current buffer, so one can execute another cmd,<br>after which the original one will be restored                            |
...
- <details>
  ...
  |          `v`           | Open Vim with Telescope window in fuzzy search mode in the repo                                                                                    |
  |          `vv`          | Open Telescope in Vim to browse recently viewed files                                                                                              |
...
- <details>
  ...
  | :--: | :------------------: | :-------------------------------------------------------------------------------------------------- |
  |  n   |     `<Leader>en`     | Toggle spell-check for English dictionary                                                           |
  |  n   |     `<Leader>ru`     | Toggle spell-check for Russian dictionary (if the latter is installed)                              |
...
the ones defined by **_evangelist_**.
