return {
  ...
  config = function()
    ...
    cmp.setup {
      ...
      --- Completion sources (corresponding plugins should be installed).
      --- Order matters.
      sources = {
        ...
        { name = "lazydev", group_index = 0 },
        {
          ...
          entry_filter = function(entry, _)
            ...
            local kind =
              types.lsp.CompletionItemKind[entry:get_kind()]
            --- Ignore LSP text suggestions. They only clutter the window.
            if kind == "Text" then
              return false
            end
          end,
